...
pageWidget(['afisha_post', 'afisha', 'basket', 'calendar', 'delivery_docs', 'faq', 'listing', 'listing_item', 'map', 'official', 'services', 'skyline', 'store', 'store_item']);